...
import IHRSNavigation from '../IHRSNavigation';
import IHRSSidebarHeader from './IHRSSidebarHeader';
		...
		<Root
			...
			leftSidebarContent={
				<div className="px-1 py-6">
					<IHRSSidebarHeader className="mb-8 px-4" />
					<FuseNavigation
						className={clsx('navigation')}
						navigation={IHRSNavigation.children}
					/>
				</div>
			}
